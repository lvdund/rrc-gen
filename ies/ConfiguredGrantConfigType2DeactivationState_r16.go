...
func (ie *ConfiguredGrantConfigType2DeactivationState_r16) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *ConfiguredGrantConfigType2DeactivationState_r16) Decode(r *uper.UperReader) error {
	var err error
	tmp := utils.NewSequence[*ConfiguredGrantConfigIndex_r16]([]*ConfiguredGrantConfigIndex_r16{}, uper.Constraint{Lb: 1, Ub: maxNrofConfiguredGrantConfig_r16}, false)
