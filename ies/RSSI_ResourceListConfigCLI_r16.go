...
func (ie *RSSI_ResourceListConfigCLI_r16) Encode(w *uper.UperWriter) error {
	var err error
	tmp := utils.NewSequence[*RSSI_ResourceConfigCLI_r16]([]*RSSI_ResourceConfigCLI_r16{}, uper.Constraint{Lb: 1, Ub: maxNrofCLI_RSSI_Resources_r16}, false)
...
func (ie *RSSI_ResourceListConfigCLI_r16) Decode(r *uper.UperReader) error {
	var err error
	tmp := utils.NewSequence[*RSSI_ResourceConfigCLI_r16]([]*RSSI_ResourceConfigCLI_r16{}, uper.Constraint{Lb: 1, Ub: maxNrofCLI_RSSI_Resources_r16}, false)
