...
func (ie *BandCombinationList_v1630) Encode(w *uper.UperWriter) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_v1630]([]*BandCombination_v1630{}, uper.Constraint{Lb: 1, Ub: maxBandComb}, false)
...
func (ie *BandCombinationList_v1630) Decode(r *uper.UperReader) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_v1630]([]*BandCombination_v1630{}, uper.Constraint{Lb: 1, Ub: maxBandComb}, false)
